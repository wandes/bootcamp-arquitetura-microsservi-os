package br.com.equipment.swagger;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.equipment"))
	...
	private ApiInfo apiInfo() {
		...
		ApiInfo apiInfo = new ApiInfoBuilder().title("API gerenciadora de equipamentos de herois")
